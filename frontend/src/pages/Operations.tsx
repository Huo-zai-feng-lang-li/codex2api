...
export default function Operations() {
  ...
  const {
    ...
    reload,
    reloadSilently,
  } = useDataLoader<OpsOverviewResponse | null>({
    initialData: null,
  ...
  const updatedLabel = overview?.updated_at
    ? formatTimeLabel(overview.updated_at)
    : "--:--:--";
        ...
        <PageHeader
          ...
          actions={
            <div className="flex items-center gap-3 max-sm:w-full max-sm:flex-col max-sm:items-stretch">
              <span className="text-sm text-muted-foreground max-sm:text-center">
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5">
                  ...
                  <OpsMetricCard
                    ...
                    sub={t("ops.pgConn", {
                      ...
                      max: overview.postgres.max_open || "∞",
                    })}
                  ...
                  <OpsMetricCard
                    ...
                    sub={t("ops.redisConn", {
                      open: overview.redis.total_conns,
                      max: overview.redis.pool_size || "-",
                    })}
                  ...
                  <OpsMetricCard
                    ...
                    sub={t("ops.totalRequestsAccum", {
                      count: formatNumber(overview.requests.total),
                    })}
                    icon={<Activity className="size-5" />}
                    tone={
                      overview.requests.active >=
                      Math.max(50, overview.runtime.total_accounts * 0.5)
                        ? "warning"
                        : "normal"
                    }
                    t={t}
                  ...
                  <OpsMetricCard
                    ...
                    sub={t("ops.goroutinesPool", {
                      available: overview.runtime.available_accounts,
                      total: overview.runtime.total_accounts,
                    })}
                    icon={<Users className="size-5" />}
                    tone={
                      overview.runtime.goroutines >=
                      Math.max(1000, overview.runtime.total_accounts * 3)
                        ? "danger"
                        : overview.runtime.goroutines >=
                            Math.max(500, overview.runtime.total_accounts * 1.5)
                          ? "warning"
                          : "normal"
                    }
                    t={t}
                  ...
                  <OpsMetricCard
                    ...
                    sub={t("ops.qpsPeak", {
                      value: overview.traffic.qps_peak.toFixed(1),
                    })}
                  ...
                  <OpsMetricCard
                    ...
                    sub={t("ops.tpsPeak", {
                      value: formatNumber(
                        Math.round(overview.traffic.tps_peak),
                      ),
                    })}
                  ...
                  <OpsMetricCard
                    ...
                    sub={
                      overview.traffic.rpm_limit > 0
                        ? t("ops.rpmLimit", {
                            value: formatNumber(overview.traffic.rpm_limit),
                          })
                        : t("ops.rpmNoLimit")
                    }
                    ...
                    tone={
                      overview.traffic.rpm_limit > 0 &&
                      overview.traffic.rpm >= overview.traffic.rpm_limit * 0.8
                        ? "warning"
                        : "normal"
                    }
                    t={t}
                  ...
                  <OpsMetricCard
                    ...
                    sub={t("ops.tpmToday", {
                      value: formatNumber(overview.traffic.today_tokens),
                    })}
                    icon={<AlertTriangle className="size-5" />}
                    tone={
                      overview.traffic.error_rate >= 5 ? "warning" : "normal"
                    }
                    t={t}
                  />
                  {overview.storage && (
